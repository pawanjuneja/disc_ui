...
export class ChangePasswordComponent implements OnInit {
  ...
  constructor(private cognito: CogServiceService, private router: Router, private invoiceService: SupplierInvoiceServiceService) {
  ...
  changePassword() {
    ...
    this.cognito.changeUserPassword(op, np).subscribe((res) => {
      ...
      if (this.msg === 'Password Changed Successfully...!') {
          this.formReset();
          this.invoiceService.changePasswordNotification().subscribe((res) => {
